  ...
  var Efte = {
    ...
    callback: function(callbackId, retValue) {
      try {
        ...
        console.log('---- callback for id: ' +  callbackId + ' - ' + callback);
        if (!callback) return;
    ...
    */
    ...
    cache: {
      ...
      removeAll: function(opts) {
        opts = opts || {};
        Efte.send_message('cacheClear', {}, function(data) {
          if (!data || !data.status) {
    ...
    push: {
      getInfo: function(success, error) {
        Efte.send_message('push_getInfo', {}, function(data) {
          if (!data || !data.status) {
      ...
      getExtra: function(success, error) {
        Efte.send_message('push_getExtra', {}, function(data) {
