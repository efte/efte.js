(function() {
    ...
    var Efte = {
        ...
        ajax: function(opts) {
            var success = opts.success || emptyFn;
            var fail = opts.fail || emptyFn;
        ...
        */
        ...
        setBarButtons: function (buttons) {
            ...
            buttons.forEach(function (button) {
                actionFns.push(button.action || emptyFn);
            });
        ...
        publish: function (name, value) {
            Efte.send_message('publish', {name: name, value: value});
        },

        /* callback(publisher's value); */
        subscribe: function (name, callback) {
            var cid = Efte.send_message('subscribe', {name: name}, function (result) {
                $.isFunction(callback) && callback(result.value);
           }); 
           return {
